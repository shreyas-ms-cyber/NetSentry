      ...
      <div className="bottom-grid">
        <div className="chart-card">
          ...
          <div className="protocol-breakdown">
            {summary?.latest_traffic?.protocol_breakdown ? (
              Object.entries(summary.latest_traffic.protocol_breakdown).map(([proto, value]) => (
        ...
        <div className="chart-card">
          ...
          <div className="top-talkers">
            {summary?.latest_traffic?.top_talkers?.length > 0 ? (
              summary.latest_traffic.top_talkers.slice(0, 5).map((talker, i) => (
                <div key={i} className="talker-item">
                  ...
                  <div className="talker-bar-track">
                    <div className="talker-bar-fill" style={{ width: `${Math.min((talker.bytes_mb || 0) / (summary.latest_traffic.top_talkers[0]?.bytes_mb || 1) * 100, 100)}%` }} />
                  </div>
                </div>
              ))
            ) : (
